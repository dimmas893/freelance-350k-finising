                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                ...
                                <input type="integer" name="no_hp" class="form-control"
                                    placeholder="Masukan No Telfon Suplier">
                            </div>
                            <div class="my-2">
                ...
                <div class="modal-content">
                    ...
                    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                <label for="no_hp">No Telpon</label>
                                <input type="integer" id="no_hp" name="no_hp" class="form-control"
                                    placeholder="Masukan No Telfon Suplier">
                            </div>
                            <div class="my-2">
                                <label for="keterangan">Keterangan</label>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-light ml-5" data-toggle="modal" data-target="#add_TU_modal">Tambah
                                    WhereHouse
                                </button>
                            </div>
