                        ...
                        <div class="modal-body">
                            <div class="my-2">
                                ...
                                <input type="text" name="nama" class="form-control"
                                    placeholder="Masukan Nama Customor">
                            </div>
                            <div class="my-2">
                                <label for="alamat">Alamat</label>
                                <input type="text" name="alamat" class="form-control"
                                    placeholder="Masukan Alamat Customor">
                            </div>
                            <div class="my-2">
                                <label for="no_hp">No Telpon</label>
                                <input type="integer" name="no_hp" class="form-control"
                                    placeholder="Masukan No Telfon Customor">
                            </div>
                            <div class="my-2">
                                <label for="keterangan">Keterangan</label>
                                <textarea name="keterangan" class="form-control" placeholder="Masukan Keterangan Customor"></textarea>
                            </div>
                        </div>
